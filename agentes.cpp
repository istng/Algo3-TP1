...
int main(int argc, char** argv){
    ...
    if (!(argc == 3 || argc == 2 || argc == 1)){
        ...
        std::cout << std::endl << "./main <activar podas> <pasaje de datos>" << std::endl;
        ...
        std::cout << std::endl << "Pasaje de datos: 1 para que sea con archivos .in, 0 manual." << std::endl;
        std::cout << "Por defecto se toma manual." << std::endl;
        return -1;
    }

    bool poda = true;
    if((argc == 3 || argc == 2) && argv[1] == "0"){poda = false;}
    bool archivos == false;
    if(argc == 3 && argv[2] == "1"){archivos = true;}
